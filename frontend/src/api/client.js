...
export const projectApi = {
  ...
  insertClip: (projectId, payload) => client.post(`/projects/${projectId}/clips/insert`, payload),
  ...
  splitClip: (projectId, clipId, splitAtSeconds) => client.post(`/projects/${projectId}/clips/${clipId}/split`, { split_at_seconds: splitAtSeconds }),
  cutOutSection: (projectId, clipId, startSeconds, endSeconds) => client.post(`/projects/${projectId}/clips/${clipId}/cut-out`, { start_seconds: startSeconds, end_seconds: endSeconds }),
